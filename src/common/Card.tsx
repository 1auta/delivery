...
export function Card({ data }: CardProps) {
  ...
  return (
    <div className="flex flex-col gap-2 rounded-lg max-w-xs p-6 hover:shadow-md text-black bg-[#F8F8F8] 2xl:max-w-[250px] xs:max-w-[180px] xs:p-3">
      ...
      <div>
        <h2 className="text-xl h-12 w-[250px] 2xl:w-48 xs:w-32 xs:text-sm">{title}</h2>
...
const CardList = () => {
  return (
    <div className="flex flex-wrap gap-4 max-w-2xl xs:justify-center 2xl:w-">
      {data.map((item, index) => (
